...
proc findQueueFamilies(pDevice: VkPhysicalDevice): QueueFamilyIndices =
  ...
  vkGetPhysicalDeviceQueueFamilyProperties(pdevice, queueFamilyCount.addr,
      queueFamilies[0].addr)
...
proc createInstance() =
  ...
  discard vkEnumerateInstanceExtensionProperties(nil, extensionCount.addr,
      extensions[0].addr)
